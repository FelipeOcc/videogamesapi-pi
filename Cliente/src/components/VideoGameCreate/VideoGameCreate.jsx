        ...
        <div className='home_container'>
            ...
            <form className='form' onSubmit={(event) => handleSubmit(event)}>
                ...
                <div className='genres_container'>
                    ...
                    <select className='genres_input' onChange={(event) => handleSelectGenre(event)}>
                        {genre.map(genre => (
                ...
                <div className='platforms_container'>
                    ...
                    <select className='platforms_input' onChange={(event) => handleSelectPlatform(event)}>
                        {platform.map(plataform => (
                            <option key={plataform.name} value={plataform.name}>{plataform.name}</option>
                        ))}
                    </select>
                </div>
                <div>
            ...
            {input.genres.map(genre => 
                <div className='x_genre_container'>
                    ...
                    <button className='x_genre_buttom' onClick={() => handleDeleteGenre(genre)}>X</button>  
                </div>  
            )}
            {input.platforms.map(platform => 
                <div className='x_platform_container'>
                    <label className='x_platform'>{platform}</label>
                    <button className='x_platform_buttom' onClick={() => handleDeletePlatform(platform)}>X</button>  
                </div>  
            )}
        </div>
    </>
