...
import '../Home/home.css'
    ...
    export default function Home(){ // Reemplazar al mapStateToProp.
    ...
    const [setOrder] = useState('') // Estado Local de la calificacion. Inicia vacio.
  ...
  //  const allGenres = useSelector((state) => state.genres);
    ...
    function handleSort(event){ // Dispatch de la calificacion.
    event.preventDefault();
    ...
    return (
        <div>
            ...
            <Link className='button_create_videogame' to= '/videogame'>Crear Videojuego</Link>
                        
            <div className='reload_container'>
            <button className='button_reload' onClick={(event) => {handleClick(event)}}>  
                Recargar     
            </button>
            </div>
